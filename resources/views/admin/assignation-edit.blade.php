...
<div class="container pb-3">
    ...
    <div class="row">
      <h3 class="col pt-2">@lang('main.assignation.edit_rule_title')</h3>
    </div>
    <hr class="mb-3 mt-0">
    ...
    <div class="editor">
      ...
      <form action="{{ route('assignation.update', $rule->id) }}" method="post">
        @csrf
        @method('put')
        ...
        <div class="row mt-3">
          ...
          <div class="form-group col-md pr-3 pr-md-1">
            ...
            <select id="group_id" name="group_id" class="form-control">
              @foreach ($groups as $gr)
                <option value="{{$gr['id']}}" @selected($rule->group_id==$gr['id'])>
          ...
          <div class="form-group col-md">
            ...
            <select id="user_id" name="user_id" class="form-control">
              <option value="0" @selected($rule->user_id==0)>@lang('main.incidents.unnasigned_selection')</option>
              @foreach ($users as $us)
              <option value="{{$us['id']}}" @selected($rule->user_id==$us['id'])>
                {{ $us['name'] }}</option>
              @endforeach
            </select>
          </div>
