...
<div class="container pb-3">
    ...
    <div class="row">
      <h3 class="col pt-2">@lang('main.sla.add_rule_title')</h3>
    </div>
    <hr class="mb-3 mt-0">
    ...
    <div class="editor">
      ...
      <form action="{{ route('slarules.store') }}" method="post">
        @csrf
        ...
        <div class="bg-slate p-2">
          ...
          <p id="vacio">@lang('main.sla.no_conditions')</p>
        ...
        <div class="form-group mt-3">
          ...
          <input type="range" id="sla" class="form-control-range" name="sla" 
            min="0" max="72" step="1" value="{{ old('sla') ?? 0 }}">
        </div>
